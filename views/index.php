...
<div 
    ...
    <div 
        ...
        <div class="text-center">
            <div class="mx-auto flex items-center justify-center h-14 w-14 rounded-full bg-red-900/20 mb-4 border border-red-900/50">
                <svg class="h-7 w-7 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                </svg>
            </div>
            <h3 class="text-xl font-bold text-white">Konfirmasi Logout</h3>
            <p class="mt-2 text-sm text-gray-400 leading-relaxed">
                Apakah Anda yakin ingin mengakhiri sesi terminal ini? <br>
                Akses ke dashboard akan ditutup.
            </p>
        </div>
        ...
        <div class="mt-8 flex space-x-3">
            <button 
                type="button"
                @click="openLogout = false"
                class="flex-1 px-4 py-2.5 text-sm font-medium text-gray-400 bg-gray-800/50 border border-gray-700 rounded-xl hover:bg-gray-800 hover:text-white transition-all duration-200">
                Batalkan
            </button>
            <button 
                hx-post="<?= url('/logout') ?>"
                hx-disabled-elt="this"
                class="flex-1 px-4 py-2.5 text-sm font-medium text-white bg-red-600 rounded-xl hover:bg-red-700 shadow-lg shadow-red-600/30 transition-all duration-200 flex items-center justify-center group">
                <span class="group-[.htmx-request]:hidden">Ya, Keluar</span>
                <svg class="animate-spin h-5 w-5 text-white hidden group-[.htmx-request]:block" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
...
<script>
// Example - Listen for background updates from Electron
